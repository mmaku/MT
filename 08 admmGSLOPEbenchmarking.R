...
ggsave("firstBench_0.1_T_F.png", plotBenchOne(firstBench_0.1_T_F), device = "png", path = "./00 Plots/01 first/", dpi = 200)
ggsave("firstBench_0.1_F_F.png", plotBenchOne(firstBench_0.1_F_F), device = "png", path = "./00 Plots/01 first/", dpi = 200)
ggsave("firstBench_0.1_T_T.png", plotBenchOne(firstBench_0.1_T_T), device = "png", path = "./00 Plots/01 first/", dpi = 200)

ggsave("firstBench_0.05_F_T.png", plotBenchOne(firstBench_0.05_F_T), device = "png", path = "./00 Plots/01 first/", dpi = 200)
ggsave("firstBench_0.05_T_F.png", plotBenchOne(firstBench_0.05_T_F), device = "png", path = "./00 Plots/01 first/", dpi = 200)
ggsave("firstBench_0.05_F_F.png", plotBenchOne(firstBench_0.05_F_F), device = "png", path = "./00 Plots/01 first/", dpi = 200)
ggsave("firstBench_0.05_T_T.png", plotBenchOne(firstBench_0.05_T_T), device = "png", path = "./00 Plots/01 first/", dpi = 200)

ggsave("firstBench_0.01_F_T.png", plotBenchOne(firstBench_0.01_F_T), device = "png", path = "./00 Plots/01 first/", dpi = 200)
ggsave("firstBench_0.01_T_F.png", plotBenchOne(firstBench_0.01_T_F), device = "png", path = "./00 Plots/01 first/", dpi = 200)
ggsave("firstBench_0.01_F_F.png", plotBenchOne(firstBench_0.01_F_F), device = "png", path = "./00 Plots/01 first/", dpi = 200)
ggsave("firstBench_0.01_T_T.png", plotBenchOne(firstBench_0.01_T_T), device = "png", path = "./00 Plots/01 first/", dpi = 200)
...
ggsave("thirdClusterBench_0.1_F_T.png", plotBenchOne(thirdClusterBench_0.1_F_T), device = "png", path = "./00 Plots/03 third/", dpi = 200)
ggsave("thirdClusterBench_0.1_T_F.png", plotBenchOne(thirdClusterBench_0.1_T_F), device = "png", path = "./00 Plots/03 third/", dpi = 200)
ggsave("thirdClusterBench_0.1_F_F.png", plotBenchOne(thirdClusterBench_0.1_F_F), device = "png", path = "./00 Plots/03 third/", dpi = 200)
ggsave("thirdClusterBench_0.1_T_T.png", plotBenchOne(thirdClusterBench_0.1_T_T), device = "png", path = "./00 Plots/03 third/", dpi = 200)

ggsave("thirdClusterBench_0.05_F_T.png", plotBenchOne(thirdClusterBench_0.05_F_T), device = "png", path = "./00 Plots/03 third/", dpi = 200)
ggsave("thirdClusterBench_0.05_T_F.png", plotBenchOne(thirdClusterBench_0.05_T_F), device = "png", path = "./00 Plots/03 third/", dpi = 200)
ggsave("thirdClusterBench_0.05_F_F.png", plotBenchOne(thirdClusterBench_0.05_F_F), device = "png", path = "./00 Plots/03 third/", dpi = 200)
ggsave("thirdClusterBench_0.05_T_T.png", plotBenchOne(thirdClusterBench_0.05_T_T), device = "png", path = "./00 Plots/03 third/", dpi = 200)

ggsave("thirdClusterBench_0.01_F_T.png", plotBenchOne(thirdClusterBench_0.01_F_T), device = "png", path = "./00 Plots/03 third/", dpi = 200)
ggsave("thirdClusterBench_0.01_T_F.png", plotBenchOne(thirdClusterBench_0.01_T_F), device = "png", path = "./00 Plots/03 third/", dpi = 200)
ggsave("thirdClusterBench_0.01_F_F.png", plotBenchOne(thirdClusterBench_0.01_F_F), device = "png", path = "./00 Plots/03 third/", dpi = 200)
ggsave("thirdClusterBench_0.01_T_T.png", plotBenchOne(thirdClusterBench_0.01_T_T), device = "png", path = "./00 Plots/03 third/", dpi = 200)              
